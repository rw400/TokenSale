...
var TraceCollector = /** @class */ (function () {
    ...
    TraceCollector.prototype.computeSingleTraceCoverageAsync = function (traceInfo) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, isContractCreation, bytecode, contractData, shortenHex, errMsg, bytecodeHex, sourceMap, pcToSourceRange;
            var _this = this;
                    ...
                    case 2:
                        ...
                        if (_.isUndefined(contractData)) {
                            ...
                            errMsg = isContractCreation
                                ...
                                : "Unable to find matching bytecode for contract address " + chalk_1.default.bold(traceInfo.address) + ", please check your artifacts. Ignoring...";
