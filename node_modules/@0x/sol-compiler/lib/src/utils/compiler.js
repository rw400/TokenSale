    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    utils_1.logUtils.warn("Artifact for " + contractName + " does not exist");
 ...
 */
function getSolcJSReleasesAsync() {
    return __awaiter(this, void 0, void 0, function () {
        var versionList, versionListJSON;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!_.isUndefined(solcJSReleasesCache)) return [3 /*break*/, 3];
 ...
 */
function compileSolcJSAsync(solcVersion, standardInput) {
    return __awaiter(this, void 0, void 0, function () {
        var solcInstance, standardInputStr, standardOutputStr, compiled;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getSolcJSAsync(solcVersion)];
                case 1:
...
function addHexPrefixToContractBytecode(compiledContract) {
    if (!_.isUndefined(compiledContract.evm)) {
        ...
        if (!_.isUndefined(compiledContract.evm.deployedBytecode) &&
