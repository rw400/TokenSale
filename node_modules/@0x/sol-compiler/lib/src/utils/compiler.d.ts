 ...
 */
export declare function getSolcJSReleasesAsync(): Promise<BinaryPaths>;
/**
 ...
 */
export declare function compileSolcJSAsync(solcVersion: string, standardInput: solc.StandardInput): Promise<solc.StandardOutput>;
/**
 * Compiles the contracts and prints errors/warnings
 * @param solcVersion Version of a solc compiler
 * @param standardInput Solidity standard JSON input
 ...
 */
export declare function getSolcJSAsync(solcVersion: string): Promise<solc.SolcInstance>;
/**
